...
=head1 Methods of HTTP::Webdav::Hip
...
=head1 Methods of HTTP::Webdav::Lock
...
=head2 int = HTTP::Webdav::Util::dav_accept_207 (userdata,$request,status)
...
=head2 $hip = HTTP::Webdav::Util::hip_xml_create ()
...
=head2 HTTP::Webdav::Util::hip_xml_parse_v (userdata,block,len)
...
=head2 int = HTTP::Webdav::Util::http_accept_2xx (userdata,$request,st)
...
=head2 int = HTTP::Webdav::Util::http_accept_always (userdata,$request,st)
...
=head2 HTTP::Webdav::Util::http_content_type_handler (userdata,value)
...
=head2 time_t = HTTP::Webdav::Util::http_dateparse (date)
...
=head2 HTTP::Webdav::Util::http_duplicate_header (userdata,value)
...
=head2 HTTP::Webdav::Util::http_handle_numeric_header (userdata,value)
...
=head2 int = HTTP::Webdav::Util::http_parse_statusline (status_line,s)
...
=head2 $session = HTTP::Webdav::Util::http_session_create ()
...
=head2 time_t = HTTP::Webdav::Util::ne_asctime_parse (date)
...
=head2 void * = HTTP::Webdav::Util::ne_calloc (len)
...
=head2 void * = HTTP::Webdav::Util::ne_md5_buffer (buffer,len,resblock)
...
=head2 HTTP::Webdav::Util::ne_md5_process_block (buffer,len,$md5ctx)
...
=head2 HTTP::Webdav::Util::ne_md5_process_bytes (buffer,len,$md5ctx)
...
=head2 void * = HTTP::Webdav::Util::ne_md5_read_ctx (ctx,resbuf)
...
=head2 int = HTTP::Webdav::Util::ne_md5_stream (stream,resblock)
...
=head2 void * = HTTP::Webdav::Util::ne_realloc (ptr,len)
...
=head2 time_t = HTTP::Webdav::Util::ne_rfc1036_parse (date)
...
=head2 char * = HTTP::Webdav::Util::ne_rfc1123_date (anytime)
...
=head2 time_t = HTTP::Webdav::Util::ne_rfc1123_parse (date)
...
=head2 char * = HTTP::Webdav::Util::ne_strdup (s)
...
=head2 char * = HTTP::Webdav::Util::ne_strndup (s,n)
...
=head2 char * = HTTP::Webdav::Util::ne_utf8_decode (str)
...
=head2 char * = HTTP::Webdav::Util::ne_utf8_encode (str)
...
=head2 HTTP::Webdav::Util::neon_debug_init (stream,mask)
...
=head2 int = HTTP::Webdav::Util::neon_version_minimum (major,minor)
...
=head2 const char * = HTTP::Webdav::Util::neon_version_string ()
...
=head2 HTTP::Webdav::Util::sbuffer_altered (buf)
...
=head2 int = HTTP::Webdav::Util::sbuffer_append (buf,data,len)
...
=head2 HTTP::Webdav::Util::sbuffer_clear (buf)
...
=head2 sbuffer = HTTP::Webdav::Util::sbuffer_create ()
...
=head2 sbuffer = HTTP::Webdav::Util::sbuffer_create_sized (size)
...
=head2 char * = HTTP::Webdav::Util::sbuffer_data (buf)
...
=head2 HTTP::Webdav::Util::sbuffer_destroy (buf)
...
=head2 char * = HTTP::Webdav::Util::sbuffer_finish (buf)
...
=head2 int = HTTP::Webdav::Util::sbuffer_grow (buf,size)
...
=head2 int = HTTP::Webdav::Util::sbuffer_size (buf)
...
=head2 int = HTTP::Webdav::Util::sbuffer_zappend (buf,str)
